...
namespace MyStarterApp.Services.Services
{
    public class EmailTestService
    {
        public bool SendEmail()
        {
            ...
            client.Credentials = new NetworkCredential("someGmail@gmail.com", "somePass1");
            ...
            message.From = new MailAddress("someSenderAddress@mailinator.com", "My Name");
            message.To.Add(new MailAddress("recipientAddress@@mailinator.com", "Their Name"));
